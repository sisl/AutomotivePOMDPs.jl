...
function EnvParams(;n_lanes::Int64 = 2,
    ...
    return EnvParams(n_lanes, roadway_length, lane_width, crosswalk_length, crosswalk_width,
                     start_pos,end_pos, speed_limit, ped_rate, ped_max_speed, ped_max_y)
end
...
"""
function CrosswalkEnv(params::EnvParams = EnvParams())
